/*
    ...
    OpenGL loader generated by glad 0.1.27 on Sat Sep 15 22:27:02 2018.
...
static void load_GL_APPLE_fence(GLADloadproc load)
{
	...
	glad_glGenFencesAPPLE =
		(PFNGLGENFENCESAPPLEPROC)load("glGenFencesAPPLE");
	...
	glad_glTestFenceAPPLE =
		(PFNGLTESTFENCEAPPLEPROC)load("glTestFenceAPPLE");
...
static void load_GL_APPLE_vertex_program_evaluators(GLADloadproc load)
{
	...
	glad_glDisableVertexAttribAPPLE =
		(PFNGLDISABLEVERTEXATTRIBAPPLEPROC)load(
...
static void load_GL_ARB_imaging(GLADloadproc load)
{
	...
	glad_glConvolutionParameterfv = (PFNGLCONVOLUTIONPARAMETERFVPROC)load(
		"glConvolutionParameterfv");
	glad_glConvolutionParameteri =
		(PFNGLCONVOLUTIONPARAMETERIPROC)load("glConvolutionParameteri");
	glad_glConvolutionParameteriv = (PFNGLCONVOLUTIONPARAMETERIVPROC)load(
		"glConvolutionParameteriv");
	glad_glCopyConvolutionFilter1D = (PFNGLCOPYCONVOLUTIONFILTER1DPROC)load(
		"glCopyConvolutionFilter1D");
	glad_glCopyConvolutionFilter2D = (PFNGLCOPYCONVOLUTIONFILTER2DPROC)load(
	...
	glad_glGetHistogramParameterfv = (PFNGLGETHISTOGRAMPARAMETERFVPROC)load(
		"glGetHistogramParameterfv");
	glad_glGetHistogramParameteriv = (PFNGLGETHISTOGRAMPARAMETERIVPROC)load(
...
static void load_GL_ARB_robustness(GLADloadproc load)
{
	...
	glad_glGetnSeparableFilterARB = (PFNGLGETNSEPARABLEFILTERARBPROC)load(
...
static void load_GL_EXT_separate_shader_objects(GLADloadproc load)
{
	...
	glad_glActiveShaderProgramEXT = (PFNGLACTIVESHADERPROGRAMEXTPROC)load(
		"glActiveShaderProgramEXT");
	glad_glBindProgramPipelineEXT = (PFNGLBINDPROGRAMPIPELINEEXTPROC)load(
		"glBindProgramPipelineEXT");
	glad_glCreateShaderProgramvEXT = (PFNGLCREATESHADERPROGRAMVEXTPROC)load(
		"glCreateShaderProgramvEXT");
	glad_glDeleteProgramPipelinesEXT =
		(PFNGLDELETEPROGRAMPIPELINESEXTPROC)load(
			"glDeleteProgramPipelinesEXT");
	glad_glGenProgramPipelinesEXT = (PFNGLGENPROGRAMPIPELINESEXTPROC)load(
		"glGenProgramPipelinesEXT");
	glad_glGetProgramPipelineInfoLogEXT =
		(PFNGLGETPROGRAMPIPELINEINFOLOGEXTPROC)load(
			"glGetProgramPipelineInfoLogEXT");
	glad_glGetProgramPipelineivEXT = (PFNGLGETPROGRAMPIPELINEIVEXTPROC)load(
...
static int find_extensionsGL(void)
{
	...
	GLAD_GL_APPLE_vertex_array_object =
		has_ext("GL_APPLE_vertex_array_object");
	GLAD_GL_APPLE_vertex_array_range =
		has_ext("GL_APPLE_vertex_array_range");
