...
#define MVECTOR_DECLARE(TYPE) VECTOR_TYPE_DECLARE(TYPE, MK_VEC(TYPE))
// names the vector
...
#define VECTOR_TYPE_DECLARE(TYPE, NAME)                                                    \
	...
	/* Declarations... */                                                              \
	/* --------------------- */                                                        \
	static inline void MK_FUNC(NAME, init)(struct NAME * vector,                       \
					       msize capacity);                            \
	static inline void MK_FUNC(NAME, reserve)(struct NAME * vector,                    \
						  const msize new_capacity);               \
	static inline void MK_FUNC(NAME, resize)(                                          \
		struct NAME * vector, const msize new_size, const TYPE val);               \
	static inline msize MK_FUNC(NAME, size)(const struct NAME *vector);                \
	static inline msize MK_FUNC(NAME,                                                  \
				    capacity)(const struct NAME *vector);                  \
	static inline void MK_FUNC(NAME, push_back)(struct NAME * vector,                  \
						    const TYPE val);                       \
	static inline TYPE MK_FUNC(NAME, pop_back)(struct NAME * vector);                  \
	static inline void MK_FUNC(NAME, set)(                                             \
		struct NAME * vector, const msize index, const TYPE val);                  \
	static inline TYPE MK_FUNC(NAME, get)(const struct NAME *vector,                   \
					      const msize index);                          \
	static inline TYPE *MK_FUNC(NAME, get_p)(                                          \
		const struct NAME *const vector, const msize index);                       \
	static inline void MK_FUNC(NAME, swap)(                                            \
		struct NAME * vector, const msize index0, const msize index1);             \
	static inline void MK_FUNC(NAME, swap_back)(struct NAME * vector,                  \
						    const msize index);                    \
	static inline void MK_FUNC(NAME, remove)(struct NAME * vector,                     \
						 const msize index);                       \
	static inline void MK_FUNC(NAME, lazy_clear)(struct NAME * vector);                \
	static inline void MK_FUNC(NAME, free)(struct NAME * vector);                      \
                                                                                           \
                                                                                           \
	/* Implementations... */                                                           \
	/* --------------------- */                                                        \
	...
	{                                                                                  \
		...
		if (new_data == NULL) {                                                    \
			fprintf(stderr,                                                    \
				...
				MK_FUNC(NAME, size)(vector),                               \
				MK_FUNC(NAME, capacity)(vector),                           \
				new_capacity);                                             \
	...
	static inline void MK_FUNC(NAME, resize)(                                          \
		struct NAME * vector, const msize new_size, const TYPE val)                \
	{                                                                                  \
		MK_FUNC(NAME, reserve)(vector, new_size);                                  \
		for (msize i = vector->size; i < vector->capacity; ++i) {                  \
			MK_FUNC(NAME, set)(vector, i, val);                                \
		}                                                                          \
	...
	static inline msize MK_FUNC(NAME, capacity)(const struct NAME *vector)             \
	{                                                                                  \
	...
	static inline void MK_FUNC(NAME, push_back)(struct NAME * vector,                  \
						    const TYPE val)                        \
	{                                                                                  \
		if (MK_FUNC(NAME, size)(vector)                                            \
		    == MK_FUNC(NAME, capacity)(vector)) {                                  \
			MK_FUNC(NAME, reserve)                                             \
			(vector, MK_FUNC(NAME, capacity)(vector) * 2);                     \
		}                                                                          \
		MK_FUNC(NAME, set)(vector, MK_FUNC(NAME, size)(vector), val);              \
		++vector->size;                                                            \
	}                                                                                  \
                                                                                           \
	/* vector_pop_back */                                                              \
	...
	static inline TYPE MK_FUNC(NAME, pop_back)(struct NAME * vector)                   \
	{                                                                                  \
		TYPE element = MK_FUNC(NAME, get)(                                         \
			vector, MK_FUNC(NAME, size)(vector) - 1);                          \
		--vector->size;                                                            \
		return element;                                                            \
	}                                                                                  \
                                                                                           \
	...
	static inline void MK_FUNC(NAME, swap)(                                            \
		struct NAME * vector, const msize index0, const msize index1)              \
	{                                                                                  \
		TYPE tmp = MK_FUNC(NAME, get)(vector, index0);                             \
		MK_FUNC(NAME, set)                                                         \
		(vector, index0, MK_FUNC(NAME, get)(vector, index1));                      \
		MK_FUNC(NAME, set)(vector, index1, tmp);                                   \
	}                                                                                  \
                                                                                           \
	/* vector_swap_back */                                                             \
	/* Swaps the specified index with the last size index. WARNING: Does               \
	...
	{                                                                                  \
		MK_FUNC(NAME, swap)                                                        \
		(vector, index, MK_FUNC(NAME, size)(vector) - 1);                          \
	}                                                                                  \
                                                                                           \
	/* vector_remove */                                                                \
	...
	static inline void MK_FUNC(NAME, remove)(struct NAME * vector,                     \
						 const msize index)                        \
	{                                                                                  \
		for (msize i = index; i < MK_FUNC(NAME, size)(vector) - 1;                 \
		     ++i) {                                                                \
			MK_FUNC(NAME, set)                                                 \
			(vector, i, MK_FUNC(NAME, get)(vector, i + 1));                    \
		}                                                                          \
		--vector->size;                                                            \
	}                                                                                  \
                                                                                           \
