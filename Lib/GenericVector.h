...
#define VECTOR_TYPE_DEFINE(TYPE, NAME)                                         \
        ...
        void NAME##_resize(struct NAME* vector, const size_t new_size,         \
                ...
                vector->capacity = new_size;                                   \
                                                                               ...
                                                                               \
        /*vector_size*/                                                        \
        size_t NAME##_size(const struct NAME* vector) { return vector->size; } \
                                                                               \
        /*vector_capacity*/                                                    \
        size_t NAME##_capacity(const struct NAME* vector) {                    \
        ...
        TYPE NAME##_pop_back(struct NAME* vector) {                            \
                ...
                NAME##_remove(vector, NAME##_size(vector));                    \
                return element;                                                \
        }                                                                      \
                                                                               \
        /*vector_set*/                                                         \
        ...
        void NAME##_remove(struct NAME* vector, const size_t index) {          \
                ...
                --vector->size;                                                \
                                                                               ...
                                                                               \
        /* vector_lazy_clear */                                                \
        void NAME##_lazy_clear(struct NAME* vector) { vector->size = 0; }      \
                                                                               \
        /*vector_free*/                                                        \
        void NAME##_free(struct NAME* vector) { free(vector->data); }
